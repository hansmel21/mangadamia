...
const styles = StyleSheet.create({
  ...
  drawCard: {
    borderWidth: 1.5,
    borderColor: "rgba(192,106,135,0.5)",
    backgroundColor: "rgba(192,106,135,0.05)",
    borderRadius: 4,
    padding: 14,
    gap: 5,
  },
  drawEyebrow: { color: "#c06a87", fontSize: 9.5, fontWeight: "900", letterSpacing: 1.6 },
  ...
  liveChip: {
    ...
    alignItems: "center",
    gap: 5,
    backgroundColor: "rgba(86,168,123,0.14)",
    borderWidth: 1,
  ...
  poolOptionMine: {
    borderWidth: 1.5,
    borderColor: "rgba(86,168,123,0.55)",
    backgroundColor: "rgba(86,168,123,0.1)",
  },
