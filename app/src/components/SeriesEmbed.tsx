...
const styles = StyleSheet.create({
  ...
  coverPlaceholder: { alignItems: "center", justifyContent: "center", backgroundColor: "rgba(107,94,204,0.1)" },
  coverInitial: { color: "rgba(107,94,204,0.7)", fontSize: 20, fontWeight: "900" },
  body: { flex: 1, gap: 2 },
  ...
  readKey: {
    borderWidth: 1,
    borderColor: "rgba(111,174,201,0.5)",
    borderRadius: 3,
    paddingHorizontal: 9,
    paddingVertical: 7,
  },
